...
DEEPSEEK_R1_LINEAR_MODELS = {
    "english": {
        "coefficient": {"a": 0.21255458456240520, "b": 3.30130739146344609},
        "input_scaler": {"mean": 944.83131738824351942, "scale": 5021.64260895033748966},
        "output_scaler": {"mean": 209.46254107089711738, "scale": 1173.90266285494203657}
    },
    "all": {
        "coefficient": {"a": 0.22450505154373973, "b": 8.79540833597452831},
        "input_scaler": {"mean": 807.95457802727003127, "scale": 4239.81308570276723913},
        "output_scaler": {"mean": 199.43104794378072597, "scale": 1029.16783644197766989}
    }
}

QWEN_QWQ_LINEAR_MODELS = {
    "english": {
        "coefficient": {"a": 0.21341799623865165, "b": 3.82603284805253008},
        "input_scaler": {"mean": 944.83131738824351942, "scale": 5021.64260895033748966},
        "output_scaler": {"mean": 211.30449535834620178, "scale": 1193.69320404608924946}
    },
    "all": {
        "coefficient": {"a": 0.22598433470605242, "b": 10.53661002654814105},
        "input_scaler": {"mean": 807.95457802727003127, "scale": 4239.81308570276723913},
        "output_scaler": {"mean": 205.04761843077943695, "scale": 1055.23896834887568730}
    }
}
...
LLAMA3_1_LINEAR_MODELS = {
    "english": {
        ...
        "input_scaler": {"mean": 944.83131738824351942, "scale": 5021.64260895033748966},
        "output_scaler": {"mean": 207.87534287998872173, "scale": 1154.52467596300607511}
    },
    "all": {
        "coefficient": {"a": 0.22339825561915416, "b": 10.38728927295912463},
        "input_scaler": {"mean": 807.95457802727003127, "scale": 4239.81308570276723913},
        "output_scaler": {"mean": 203.01627504358330611, "scale": 1015.42000366528520772}
    }
}